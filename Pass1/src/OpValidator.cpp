...
OpValidator::OpValidator()
{
    //ctor
}
int OpValidator::getOperandType(string operand) {
...
bool OpValidator::isCompatible(int operandType, string opCode, string operand) {
...
bool OpValidator::isNumberPositive(string operand) {
...
bool OpValidator::isRegister(string operand) {
    using namespace std::regex_constants;
...
bool OpValidator::isAbsolute(int operandType) {
...
bool OpValidator::isRelative(int operandType) {
if (operandType == 1 || operandType == 3
        || operandType == 4 || operandType == 10
        || operandType == 12 || operandType == 13
        || operandType == 14) {
